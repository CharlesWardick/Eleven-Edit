...
// INTENTIONALLY PARKED / UNWIRED (Charlie's call). This map and getCabThumbSrc
// below are a partial, deliberately-abandoned cab-thumbnail feature: fully
// working on their own, but nothing calls getCabThumbSrc. Wiring a per-cab-type
// thumbnail into the chain row was found to impact much of the existing chain-row
// work, and the icon wasn't wanted enough to justify that, so the effort was
// stopped here on purpose. Left in place as a head start for a future/open-source
// contributor — NOT dead-by-mistake; do not remove it as "unused" in a sweep.
//
